...
/**
 * Per-article unique cover image. Each article has its own dedicated picture
 * at /images/articles/<id>.svg generated by scripts/generate-article-covers.mjs.
 *
 * To replace any cover with a real photo: drop a JPG/PNG/WEBP at
 * /public/images/articles/<id>.<ext> and update the entry below to point
 * at it (e.g. '/images/articles/what-is-voip.jpg'). No code changes needed.
 */
const ID_IMAGES: Record<string, string> = {
  'what-is-voip': '/images/articles/what-is-voip.svg',
  'sip-trunk-vs-pri': '/images/articles/sip-trunk-vs-pri.svg',
  'voip-for-call-centers': '/images/articles/voip-for-call-centers.svg',
  'wholesale-voip-explained': '/images/articles/wholesale-voip-explained.svg',
  'voip-security-guide': '/images/articles/voip-security-guide.svg',
  '3cx-sip-trunk-setup': '/images/articles/3cx-sip-trunk-setup.svg',
  'asterisk-voip-setup': '/images/articles/asterisk-voip-setup.svg',
  'freepbx-setup-guide': '/images/articles/freepbx-setup-guide.svg',
  'cloud-pbx-benefits': '/images/articles/cloud-pbx-benefits.svg',
  'voip-codecs-explained': '/images/articles/voip-codecs-explained.svg',
  'voip-technology-guide': '/images/articles/voip-technology-guide.svg',
  'asterisk-pbx-guide': '/images/articles/asterisk-pbx-guide.svg',
  'voip-evolution': '/images/articles/voip-evolution.svg',
  'voip-benefits-business': '/images/articles/voip-benefits-business.svg',
  'voip-security-best-practices': '/images/articles/voip-security-best-practices.svg',
  'hosted-vs-on-premise-voip': '/images/articles/hosted-vs-on-premise-voip.svg',
};
